...
public class Led_in_service extends Service {

    private static final String TAG = "Led_in_service";
    ...
    public void onCreate() {
        ...
        try {
            Log.i(TAG, "启动Led_in_service" + ZldNew2Activity.zldNew2Activity.getLed_in().getLedip());
        } catch (Exception e) {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if ( textData==null && voiceData==null && START_TIME+1000*3 < TimeUtil.getCurrentTime() ){
