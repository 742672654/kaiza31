...
import com.cz.fragment.EntranceBase;
import com.vz.tcpsdk;



public class Sensor_in_service extends Service {


    private static final String TAG = "Sensor_in_service";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        int sxt_handle = EntranceBase.sxt_handle;
        ...
        if ( sxt_handle == -1 || !tsdk.isConnected( sxt_handle ) || ZldNew2Activity.sxtOK > 0 ){
            ...
            try{
                ...
                if (  pingmins >3 ){
                    ...
                    message.what = ZldNew2Activity.restart_in_sxt_handle;
...
//            bundle.putString( "joinType",TAG );
//            Message message = new Message();
//            message.what = ZldNew2Activity.in_photo;
//            message.setData(bundle);
//            Handler handler = ZldNew2Activity.getHandler();
//            handler.sendMessage(message);
//            Log.i(TAG,"入口触发循环拍照");
