...
public class ParkingBean implements Serializable {
    ...
    public List<FreeResons> getFreereasons() {
        return freereasons;
    }

    public void setFreereasons(List<FreeResons> freereasons) {
    ...
    public String getIshdmoney() {
        return ishdmoney;
    }

    public void setIshdmoney(String ishdmoney) {
