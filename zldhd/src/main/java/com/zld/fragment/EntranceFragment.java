...
//        initFrame();
    ...
    private void initView(View rootView) {
        lnentrance = rootView.findViewById(R.id.ln_entrance);
        imgentrance = rootView.findViewById(R.id.img_entrance);
        iv_entrance = rootView.findViewById(R.id.iv_entrance);
        btn_photo = rootView.findViewById(R.id.btn_photo);
        btn_entrance_open_pole = rootView.findViewById(R.id.btn_entrance_open_pole);
