...
public class ParkinfoFragment extends BaseFragment{
	...
	private void initView(View rootView) {
        tv_idle_carport_num = rootView.findViewById(R.id.tv_idle_carport_num);
        tv_work_time = rootView.findViewById(R.id.tv_work_time);
        tv_tcb_pay = rootView.findViewById(R.id.tv_tcb_pay);
        tv_tcb_pay_money = rootView.findViewById(R.id.tv_tcb_pay_money);
        tv_cash_pay = rootView.findViewById(R.id.tv_cash_pay);
        tv_cash_pay_money = rootView.findViewById(R.id.tv_cash_pay_money);
        btn_charge_people = rootView.findViewById(R.id.btn_charge_people);
        btn_charge_number = rootView.findViewById(R.id.btn_charge_number);
		btn_charge_number.setText("默认");
        tv_show_money = rootView.findViewById(R.id.tv_show_money);
	...
	public void getChargePeopleInfo(){
		...
		if(!AppInfo.getInstance().getIsLocalServer(activity)){//是本地服务器则没有平板本地化的感念
            ...
            Log.e("isLocal", "ParkinfoFragment4 getChargePeopleInfo get isLocal " + param);
