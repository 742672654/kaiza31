...
public class ParkrecordFragment extends Fragment{
    ...
    private String TAG = "ParkrecordFragment3";
	...
	private void initView(View rootView) {
        iv_park_record = rootView.findViewById(R.id.iv_park_record);
		//tv_park_record = (TextView) rootView.findViewById(R.id.tv_park_record);
        fl_tcb_loading_right = rootView.findViewById(R.id.fl_tcb_loading_right);
	...
	public interface ParkRecordListener{
        void refreshSmallCarPlate(Bitmap bitmap);
	}
}
